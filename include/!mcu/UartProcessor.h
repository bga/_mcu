...
struct UartProcessor {
	...
	enum {
		Error_ok = staticSwapBytes32('OK\x00\x00'), 
		Error_bufferOverflow = staticSwapBytes32('#OVF'), 
		Error_nameNotFound = staticSwapBytes32('#NAM'), 
//		Error_valueSize = staticSwapBytes32('#V_S'), 
//		Error_valueData = staticSwapBytes32('#V_D'), 
		Error_valueSize = staticSwapBytes32('#VSI'), 
		Error_valueData = staticSwapBytes32('#VDA'), 
		Error_unknownOperator = staticSwapBytes32('#OP\x00'), 
		Error_unknown = staticSwapBytes32('#UNK'), 
//		Error_ = '#', 
	};
